...
const casos: CasoAtuacao[] = [
  ...
  // ── 2º Seminário APPGG ──
  {
    ...
    atuacao: "APPGGs redesenharam o modelo, substituindo a programação por quantidade de rondas por roteiros diários de policiamento (RDP), baseados em períodos de patrulhamento e baseamento, cruzando dados de criminalidade e produtividade policial.",
  ...
  },
  {
    ...
    atuacao: "APPGGs modelaram e implantaram uma Inspetoria da GCM com efetivo especializado e dedicado à proteção de pessoas e ações sociais, com foco central no Programa Guardiã Maria da Penha.",
  ...
  },
  {
    ...
    atuacao: "APPGGs estabeleceram equipe especializada de profissionais treinados na utilização de drones para finalidades de política pública, valendo-se da expertise dos próprios profissionais da SMSU.",
  ...
  },
  {
    ...
    atuacao: "APPGGs coordenaram a municipalização da Agenda 2030, estabelecendo a governança da Comissão Municipal ODS com garantia de paridade de gênero e alinhamento aos instrumentos de planejamento.",
  ...
  },
  {
    ...
    atuacao: "APPGGs incrementaram o SMAE para automatizar processos: introduziram a edição de lote, permitindo atualizar mais de 1.000 obras simultaneamente, e novos instrumentos de precisão.",
  ...
  },
  {
    ...
    atuacao: "APPGGs organizaram discussões entre usuários finais (SEPLAN) e desenvolvedores (FGV), construindo uma trilha de prioridades para atender às demandas mais urgentes de quatro módulos do sistema.",
  ...
  },
  {
    ...
    atuacao: "APPGGs consolidaram informações, geraram insumos para decisões estratégicas e deram suporte aos órgãos responsáveis, destravando gargalos e difundindo boas práticas de gestão de projetos.",
  ...
  },
  {
    ...
    atuacao: "APPGG montou do zero o curso 'Teoria e Prática da Advocacia Pública Municipal', estabeleceu fluxos para acompanhamento de monografias jurídicas e relatórios trimestrais.",
  ...
  },
  {
    ...
    atuacao: "APPGG promoveu reorganização do CEPEUC, estabeleceu melhores fluxos com a Secretaria da Fazenda e estudou instrumentos alternativos ao cumprimento da função social da propriedade.",
  ...
  },
  {
    ...
    atuacao: "APPGG levantou o histórico do programa, realizou diagnóstico com dados do Cadastro Único e construiu cenários orçamentários para retirar elegíveis da linha da pobreza.",
  ...
  },
  {
    ...
    atuacao: "APPGG captou informações de todas as áreas, estabeleceu interlocução qualificada e desenvolveu instrumental validado para modelagem organizacional e dimensionamento da força de trabalho.",
  ...
  },
  {
    ...
    atuacao: "APPGG liderou a implantação de um sistema CRM (Dynamics 365) para acompanhamento da jornada dos cidadãos nos programas da Secretaria, automatizando processos e centralizando dados.",
  ...
  },
  {
    ...
    atuacao: "APPGGs conduziram cooperação técnica com o Ministério de Gestão para desenvolver, adaptar e implementar o Contratos.gov.br na Prefeitura, integrando-o aos sistemas existentes.",
  ...
  },
  {
    ...
    atuacao: "APPGG estruturou repositório de pesquisas, identificou necessidades de avaliação e buscou modelo de Policy Lab onde pesquisa e formulação caminhem juntas, com parcerias e contratações.",
  ...
  },
  {
    ...
    atuacao: "APPGG criou o Escritório de Projetos com manual, templates padronizados e modelo de avaliação de maturidade, apoiando Coordenadorias no mapeamento de projetos e iniciativas.",
  ...
  },
  {
    ...
    atuacao: "APPGGs alinharam instrumentos de planejamento e consolidaram modelo de gestão orientado a metas, governança, integridade e participação das unidades da PGM.",
  ...
  },
  {
    ...
    atuacao: "APPGG criou formulários temáticos com triagem automática para organizar solicitações, padronizar informações e agilizar respostas, direcionando demandas ao responsável correto.",
  ...
  },
  {
    ...
    atuacao: "APPGGs construíram visão de futuro, Missão, Visão e Valores, baseados em dados, diálogo e etapas estruturadas. Diagnóstico concluído, relatórios publicados, oficinas realizadas.",
  ...
  },
  {
    ...
    atuacao: "APPGGs realizaram diagnóstico, modelagem institucional e alinhamento para modernizar atribuições, áreas e quadro de cargos mediante proposta articulada.",
  ...
  },
  {
    ...
    atuacao: "APPGG identificou, mapeou e melhorou os principais processos, articulando alterações com equipes, líderes e outras pastas envolvidas como SMIT e Secretaria da Fazenda.",
  ...
  },
  {
    ...
    atuacao: "APPGG estruturou o PLATUM com ampla participação social, retomando o COMTUR e realizando workshops, consulta pública e a 1ª Conferência Municipal de Turismo.",
  ...
  },
  {
    ...
    atuacao: "APPGG implantou nova versão do SGP e ampliou para toda a rede, integrando todas as etapas e modalidades de ensino, conectando escolas e famílias via sistemas digitais.",
  ...
  },
  {
    ...
    atuacao: "APPGGs coordenaram processo colaborativo com consultas públicas, oficinas e diálogo multissetorial para definir ações concretas de governo aberto.",
  ...
  },
  {
    ...
    atuacao: "APPGG estruturou e coordenou todas as etapas do pleito: edital, sistema eletrônico, comissões eleitorais, inscrições e capacitações para garantir um processo democrático e transparente.",
  ...
  },
  {
    ...
    atuacao: "APPGGs qualificaram o diálogo com cidadãos e incorporaram propostas nos instrumentos da Secretaria de Saúde, com encontros formativos, nota metodológica e devolutivas publicadas.",
  ...
  },
  {
    ...
    atuacao: "APPGGs elaboraram minuta de decreto para redefinir competências, criar novas unidades e fortalecer a articulação territorial e social da Secretaria.",
  ...
  },
  {
    ...
    atuacao: "APPGG desenvolveu o 'Mapa de Necessidades de RH', quantificando a necessidade de pessoal por meio de entrevistas, formulários e eventos com equipes de toda a cidade.",
  ...
  },
  {
    ...
    atuacao: "APPGG estruturou o novo POT, definindo fluxos, responsabilidades e instrumentos; qualificou o trabalho de até 5.000 Agentes de Busca Ativa Escolar (ABAEs) por meio de formação e materiais orientadores.",
  ...
  },
  {
    ...
    atuacao: "APPGG definiu funções, fluxos de trabalho e instrumentos de monitoramento; integrou atuações psicopedagógica e psicossocial; estruturou contratação de OSC para o atendimento.",
  ...
  },
  {
    ...
    atuacao: "APPGG organizou ações do Comitê intersecretarial, estruturou reuniões e pautas, sistematizou diagnósticos e desenvolveu protocolos emergenciais e preventivos.",
  ...
  },
  {
    ...
    atuacao: "APPGG documentou o conhecimento acumulado pelas equipes, criando perfis comportamentais e estratégias de engajamento replicáveis para gestão da mudança institucional.",
  ...
  },
  {
    ...
    atuacao: "APPGG redesenhou o comunicado de cobrança usando princípios de ciências comportamentais, testando seis versões de cartas em experimento randomizado com 15.348 contribuintes.",
  ...
  },
  {
    ...
    atuacao: "APPGGs desenvolveram glossário em linguagem simples, com quase 200 termos e expressões, integrado ao Diário Oficial e Portal de Transparência.",
  ...
  },
  {
    ...
    atuacao: "APPGG produziu parâmetros comuns para atuação dos equipamentos da SMDHC, respeitando especificidades de cada público-alvo e fortalecendo a noção de atuação em rede.",
  ...
  },
  {
    ...
    atuacao: "APPGGs elaboraram protocolos integrados e apoiaram implementação com cursos de capacitação e ações de sensibilização para atuação integrada entre diferentes políticas públicas.",
  ...
  },
  {
    ...
    atuacao: "APPGGs estruturaram processos de coleta e processamento, criaram rede de pontos focais e padronizaram milhões de registros retroativos para produzir indicadores confiáveis.",
  ...
  },
  {
    ...
    atuacao: "APPGGs organizaram a Conferência com 20 grupos de trabalho em 5 eixos temáticos, garantindo diversidade de atores e inclusão de diferentes segmentos da sociedade.",
  ...
  },
  {
    ...
    atuacao: "APPGG desenhou fluxos operacionais, formou e liderou equipe, e criou editais com cotas para regiões periféricas (menor IDH) para descentralizar os recursos do incentivo fiscal.",
  ...
  },
  {
    ...
    atuacao: "APPGG desenhou todo o fluxo da Plataforma Integrada, articulando SMC e Secretaria da Fazenda para integração com o SOF e expansão para todos os incentivos fiscais municipais.",
  ...
  },
  {
    ...
    atuacao: "APPGG conduziu processo de escuta com servidores, visitas a todas as áreas, diagnóstico da pasta e definição dos eixos de atuação em Economia Criativa e sua modelagem organizacional.",
  ...
  },
  {
    ...
    atuacao: "APPGGs visitaram as 32 Subprefeituras, escutaram servidores de diversos níveis hierárquicos e consolidaram percepções difusas em um documento único e organizado.",
  ...
  },
  {
    ...
    atuacao: "APPGGs realizaram visitas, reuniões e oficinas junto a servidores das 32 Subprefeituras, construindo processo participativo com instrumentos de coleta e propostas de nova modelagem.",
  ...
  },
  {
    ...
    atuacao: "APPGGs criaram site responsivo para consulta a cardápios, o primeiro chatbot da Prefeitura (Robô Edu) e um Editor de Cardápios para a gestão — tudo em código aberto e com apoio da UNESCO.",
  ...
  },
  {
    ...
    atuacao: "APPGGs desenvolveram metodologia estruturante de participação social, sistematizaram resultados de múltiplos formatos (Participe+, debates, oficinas) e articularam equipes internas.",
  ...
  },
  {
    ...
    atuacao: "APPGGs estruturaram 15 Encontros Regionais preparatórios e conduziram dois dias de Conferência, descentralizando o debate e captando demandas locais para a PNDU.",
  ...
  },
  {
    ...
    atuacao: "APPGGs desenvolveram estratégia de captação de recursos, alinhando diagnósticos e Planos Setoriais para direcionar investimento em infraestrutura, modernização e ampliação de cobertura.",
